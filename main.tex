...
Interaction Database (PID) using a method proposed in. Second, we propose an automatic                                     %ici il manque une reference.
...
%finally keywords
\begin{IEEEkeywords}
 Model construction, data integration, parameters estimation, large-scale network.
\end{IEEEkeywords}
