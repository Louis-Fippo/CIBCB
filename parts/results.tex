...
\begin{itemize}
 ...
 \item We can reproduce tendances of the dynamic of components as illustrate in \pref{fig:rwos} and \pref{fig:rws}.
...
The main important remark that we can made in this result \pref{fig:rwos} is the occurence of oscillations. This is not the expect result 
...
On the contrary of the previous result, \pref{fig:rws} show us that with the introduction of the synchronization gate, we can
...
clearly elimination of the observed oscillation in \pref{fig:rwos}. 
